...
<div class="dropdown">
  ...
  <ul role="list" id="actions-menu" style="display:none">
    <li>
...
```html
<article>
  <img src="./post-thumbnail.png" alt="Feature name" />
  <h3>Feature name</h3>
  <p>Description</p>
  <a href="/item-title">
    Learn more <span class="visually-hidden">about feature name<span>
  </a>
</article>
```
...
<article>
  <a href="/item-title">
    <img src="./item-thumbnail.png" alt="Item title" />
  </a>
  <h3>
